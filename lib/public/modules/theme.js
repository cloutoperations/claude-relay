// Stubs — setTerminalTheme/updateMermaidTheme are called inside try/catch in applyTheme
var setTerminalTheme = function () {};
var updateMermaidTheme = function () {};
...
export function initTheme() {
  ...
  // Sync theme across browser tabs via localStorage
  window.addEventListener("storage", function (e) {
    if (e.key === STORAGE_KEY && e.newValue && e.newValue !== currentThemeId) {
